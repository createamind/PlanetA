...
NUM_GPU, BATCHSIZE, CHUNK_LEN = 1, 10, 10
REWARD_FUNC = 'custom3'
USE_SENSOR = 'use_rgb'
NUM_CHANNELS = 3
...
# USE_SENSOR = 'use_rgb'
# NUM_CHANNELS = 3
# SCENARIO = 'TOWN2_NPC'  # 'TOWN2_ONE_CURVE_STRAIGHT_NAV' #  'TOWN2_WEATHER_NPC'  #
# LOGDIR = '~/Data/planet/carla128_planning'
...
# NUM_CHANNELS = 3
# SCENARIO = 'TOWN2_NPC'  #'TOWN2_ONE_CURVE_STRAIGHT_NAV' #   'TOWN2_WEATHER_NPC'  #
# LOGDIR = '~/Data/planet/carla128NPC_all' # carla_test128_angular'
