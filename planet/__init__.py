...
# TASK_NAME="{tasks: [carla]}"; ENABLE_EXPERT=0.5; PLANNING=False; TESTING=False
...
TESTING=True; TASK_NAME="{tasks: [carla]}"; ENABLE_EXPERT=0.5; PLANNING=False;
STATES = ['reward','angular_speed_degree']#,'collided','forward_speed','intersection_offroad','intersection_otherlane']
IMG_SIZE = (128, 128)
H_SIZE, S_SIZE = 200, 50
...
USE_SENSOR, NUM_CHANNELS ='use_rgb', 3  # 'use_2rgb', 6  #
SCENARIO = 'TOWN2_CARS' #'TOWN2_ONE_CURVE_STRAIGHT_NAV' # 'TOWN2_NPC'  #    'TOWN2_WEATHER_NPC'  #
LOGDIR = '~/Data/planet/carla128_test3'
...
# NUM_GPU, BATCHSIZE, CHUNK_LEN = 1, 1*5, 5
# REWARD_FUNC = 'custom3'
# USE_SENSOR = 'use_rgb'
# NUM_CHANNELS = 3
# SCENARIO = 'TOWN2_ONE_CURVE_STRAIGHT_NAV' # 'TOWN2_NPC'  #   'TOWN2_WEATHER_NPC'  #
