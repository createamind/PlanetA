...
class BatchEnv(object):
  ...
  def step(self, actions):
    ...
    info_cmd = np.array([[dict_i['next_command_id'],dict_i['goal_heading_degree'],dict_i['current_heading_degree'],dict_i['dist_to_intersection']]\
                         for dict_i in info]).astype(np.float32)            # for carla, info is the driving command.
